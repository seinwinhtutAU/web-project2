...
export default function MonthView({
  ...
  onDropMonth: (e: React.DragEvent, day: number) => void;
  ...
  const handleDateUpdate = async (taskId: string, newDay: number) => {
    try {
  ...
  const handleDropWithAPI = async (e: React.DragEvent, day: number) => {
